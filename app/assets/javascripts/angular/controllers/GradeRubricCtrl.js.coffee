@gradecraft.controller 'GradeRubricCtrl', ['$scope', 'Restangular', 'CourseBadgePrototype', 'MetricBadgePrototype', 'RubricGradePrototype', 'TierPrototype', '$http', ($scope, Restangular, CourseBadgePrototype, MetricBadgePrototype, RubricGradePrototype, TierPrototype, $http) -> 
